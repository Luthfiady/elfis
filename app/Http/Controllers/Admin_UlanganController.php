...
class Admin_UlanganController extends Controller {
...
// -------------------------------------------------------- ULANGAN EDIT --------------------------------------------------------
	...
	public function ulangan_edit($nama_group_ulangan, $id) {
		...
		if(session('id_group') == 3) {
			...
			return view('view_admin/ulangan/ulangan_edit')->with('id_ulangan', $id)->with('nama_group_ulangan', $nama_group_ulangan);
