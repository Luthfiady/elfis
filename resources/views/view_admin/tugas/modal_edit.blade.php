...
<div class="modal-dialog modal-width-index modal-lg">
    <div class="modal-content">
      ...
      <form method="post" target="target_submit" class="form form-horizontal" enctype="multipart/form-data" action="{{ URL::to('admin/tugas_edit') }}" data-toggle="validator">
      ...
      <div class="modal-body">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input readonly type="text" protected id="edit_file_tugas" name="edit_file_tugas_lama" class="form-control inform-height"/>
            </div>
            <div class="col-sm-1"></div>
