...
<li><a href="{{ URL::to('admin/latihan') }}">Latihan</a></li>
@stop
...
<div class="main-content">
    ...
    <div class="form-group" style="float:right;">
        ...
        <a href="{{URL::to('admin/latihan')}}" class="btn btn-sm btn-primary" id="redirect" style="display:none;"> </a>
    </div>
	</form>
