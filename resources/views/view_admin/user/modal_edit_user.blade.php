      ...
      <div class="modal-body">
        <form id="add_form" class="form form-horizontal" role="form" data-toggle="validator">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control inform-height" id="edit_id_user" placeholder="ID User" required>
            </div>
            <div class="col-sm-1"></div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control inform-height" id="edit_nama_user" placeholder="Nama User" required>
            </div>
            <div class="col-sm-1"></div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <input type="text" class="form-control inform-height" id="edit_password" placeholder="Password" required>
            </div>
            <div class="col-sm-1"></div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <select class="form-control" id="edit_disabled" required>
