    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="add_form" class="form form-horizontal" role="form" data-toggle="validator">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea id="soal_kuis" rows="3" class="form-control" placeholder="Soal" required> </textarea>
            </div>
            <div class="col-md-1"></div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-2">
              <select class="form-control" id="jwb_benar" required>
      ...
      <div class="modal-footer">
          ...
          <button type="reset" id="reset_add_form" class="btn btn-primary btn-sm">Reset</button>
	        <a type="submit" id="simpan_soal" class="btn btn-primary btn-sm" value="save">Simpan</a>
