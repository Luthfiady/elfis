...
<link rel="stylesheet" type="text/css" href="{{ asset('public/css/apps/ulangan_siswa.css') }}">

@section('add_bread_siswa')
<li><a href="{{ URL::to('siswa/ulangan') }}">Ulangan</a></li>
@stop
...
<div class="main-content">
	...
	<div class="row row-judul">
		<div class="col-md-6">
			<h4 class="judul-soal"> {{$nama_group_ulangan}} </h4>
		</div>
...
<script type="text/javascript" src="{{asset('public/js/apps/siswa_jawab_ulangan.js')}}"></script>
