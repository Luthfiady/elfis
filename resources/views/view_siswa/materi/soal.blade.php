...
<li><a href="{{ URL::to('siswa/latihan') }}">Latihan</a></li>
@stop
...
<div class="main-content">
	...
	<input type="hidden" id="id_group_latihan" value="" />
	<input type="hidden" id="session_durasi" value="{{$session_durasi}}" />

	<div class="row row-judul">
		<div class="col-md-6">
			<h4 class="judul-soal"> {{$nama_group_latihan}} </h4>
		</div>
...
<script type="text/javascript" src="{{asset('public/js/apps/siswa_jawab_latihan.js')}}"></script>
