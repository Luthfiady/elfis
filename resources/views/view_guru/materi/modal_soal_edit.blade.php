...
<div class="modal-dialog modal-width-index modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <p class="modal-title">Ubah Latihan</p>
      </div>
      ...
      <div class="modal-body">
        <form id="add_form" class="form form-horizontal" role="form" data-toggle="validator">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-8">
              <textarea id="edit_soal_latihan" rows="3" class="form-control" placeholder="Soal" required></textarea>
            </div>
            <div class="col-md-1"></div>
      ...
      <div class="modal-footer">
        <div class="form-group">
          <input type="hidden" id="edit_id_latihan">
